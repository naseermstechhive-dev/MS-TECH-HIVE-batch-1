  ...
  return (
    <footer className={footerBg}>
      ...
      <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
        ...
        <div>
          <h3 className={`text-lg font-semibold ${headingText} mb-4`}>
            {t("footer.quickLinks")}
          </h3>
          <ul className='space-y-2 '>
            <li><Link className={`${linkText}`} to="/">{t("nav.home")}</Link></li>
            <li><Link className={`${linkText}`} to="/About">{t("nav.about")}</Link></li>
            <li><Link className={`${linkText}`} to="/Services">{t("nav.services")}</Link></li>
            <li><Link className={`${linkText}`} to="/industries">{t("nav.industries")}</Link></li>
            <li><Link className={`${linkText}`} to="/Contact">{t("nav.contact")}</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className='space-y-3'>
            ...
            <div className='flex items-center space-x-3'>
              ...
              <a href="https://maps.app.goo.gl/xuJKp9urXsuoBeab9" target='_blank'
                className={`${linkText}`}>
                View Location
              </a>
            </div>
