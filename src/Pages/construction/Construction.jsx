      ...
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          ...
          >
            ...
            <div
              className="absolute -bottom-6 -left-6 bg-yellow-500 text-gray-900 px-6 py-4 rounded-xl shadow-lg flex flex-col items-center justify-center w-24"
              data-aos="zoom-in"
              data-aos-delay="300"
            >
              <HardHat className="w-7 h-7 text-gray-900" />
              <span className="text-sm font-semibold leading-tight">Smart</span>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {[
            ...
            <div
              key={i}
              className={`${cardBg} p-8 rounded-xl ${cardHover} transition-colors group hover:scale-105`}
              data-aos="fade-up"
